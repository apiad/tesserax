...
These layouts are perfect for linear arrangements.
...
with Canvas() as c:
    ...
    with RowLayout(gap=10, align="middle") as row:
        ...
        Rect(20, 20, fill=Colors.LightGray)
    ...
    # Layouts are Shapes, so they can be nested!
    col.translated(100, 0)
...
> **Note**: Do not confuse `tesserax.layout.Grid` (positioning) with `tesserax.path.Grid` (routing connections).
