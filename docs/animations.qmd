...
### 1. The Manual Way: Frame-by-Frame
...
with Canvas() as canvas:
    # A background is usually good for video
    Square(100, fill=Colors.White, stroke=Colors.Transparent)
...
with Canvas() as canvas:
    Square(150, fill=Colors.White, stroke=Colors.Transparent)
...
# Define animations
move_box = box.animate.rotate(deg(90)) | box.animate.translate(0, 20)
fade_ball = ball.animate.scale(0.5)

# Run them together (box moves sequentially, ball scales in parallel)
scene.play(move_box, fade_ball, duration=2.0)
...
with Canvas() as c:
    Square(120, fill=Colors.White, stroke=Colors.Transparent)
    # Start as a Triangle
...
with Canvas() as c:
    Square(200, fill=Colors.White, stroke=Colors.Transparent)
