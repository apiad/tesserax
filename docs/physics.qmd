...
with Canvas() as canvas:
    floor = Rect(600, 50, fill="#333").translated(300, 380)
    box = Rect(50, 50, fill="steelblue").translated(250, 100)
    ball = Circle(15, fill="orange").translated(350, 100)
    spring_line = Line(
        lambda: box.anchor("center"), lambda: ball.anchor("center"), stroke="gray"
    )
